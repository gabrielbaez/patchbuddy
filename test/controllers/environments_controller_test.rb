...
class EnvironmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create environment" do
    assert_difference("Environment.count") do
      post environments_url, params: { environment: { description: @environment.description, name: @environment.name } }
    end
  ...
  test "should update environment" do
    patch environment_url(@environment), params: { environment: { description: @environment.description, name: @environment.name } }
